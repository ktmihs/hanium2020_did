                ...
                <div class="col-lg-12">
                  <div class="p-5">
                    ...
                    <form class="user">
                      ...
                      <div class="form-group row">
                        <div class="col-sm-2"">
                          <a href="request_detail_user.jsp" class="btn   btn-user btn-block" style="background-color:red; color: white"><i class="fas fa-trash"></i>   취소  </a>
                        ...
                        <div class="col-sm-2">
                          <a href="request_detail_donor.jsp" class="btn   btn-user btn-block" style="background-color:#1cc88a; color: white; width: 110px;"><i class="fas fa-check"></i> 기부하기  </a>
                          <!-- <button type="text" class=" btn form-control bg-gray-400 form-control-user"  style="border:1px solid red; text-align:center;" > <p style="border:1px solid red; text-align:center; vertical-align: middle;" >중복확인</p></button> -->
                        </div>
                      </div>
